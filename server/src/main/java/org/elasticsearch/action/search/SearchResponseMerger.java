...
final class SearchResponseMerger {
    ...
    SearchResponse getMergedResponse(Clusters clusters) {
        ...
        for (SearchResponse searchResponse : searchResponses) {
            ...
            totalQueryTime+=searchResponse.getQueryTime();
            totalFetchTime+=searchResponse.getFetchTime();
            totalRewriteTime+=searchResponse.getRewriteTime();
            totalNumberOfSegments+=searchResponse.getTotalSegments();
        ...
        return new SearchResponse(response, null, totalShards, successfulShards, skippedShards, tookInMillis, shardFailures, clusters,totalWaitTime,totalExecTime,totalNumTask,totalQueryTime,totalFetchTime,totalRewriteTime,totalNumberOfSegments);
    }
